...
export PATH="$PATH:/Users/spencer/.dotnet/tools"

  export NVM_DIR="$HOME/.nvm"
  [ -s "/opt/homebrew/opt/nvm/nvm.sh" ] && . "/opt/homebrew/opt/nvm/nvm.sh"  # This loads nvm
  [ -s "/opt/homebrew/opt/nvm/etc/bash_completion.d/nvm" ] && . "/opt/homebrew/opt/nvm/etc/bash_completion.d/nvm"  # This loads nvm bash_completion

# Add local bin containing rust-analyzer to path
...
# project shortcuts
alias nw="cd ~/projects/nanoWizz"
alias nwfa="cd ~/projects/nanoWizz/frontend/app"
alias nwbf="cd ~/projects/nanoWizz/backend/flightsearch"
